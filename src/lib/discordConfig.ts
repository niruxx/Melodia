/**
 * TuneBox's own Discord Application ID, used for Rich Presence.
 *
 ...
 * -> name it "TuneBox" -> copy the Application ID from General Information.
 * Takes under a minute, no approval needed.
 */
export const DISCORD_APP_ID = "REPLACE_WITH_TUNEBOX_DISCORD_APPLICATION_ID";
